...
function App() {
  return (
    <>
      <div className="w-full min-h-screen bg-gray-200 box-border">
        ...
        <div className="w-full max-w-2xl h-auto mx-auto  my-5 overflow-hidden rounded-3xl">
          ...
          <div className="bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-violet-500 to-90% p-5 rounded-lg mx-4">
